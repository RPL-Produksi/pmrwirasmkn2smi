<header
    ...
    <nav
        ...
        <div class="flex justify-between items-center gap-x-1">
            <a class="flex items-center justify-between gap-x-1 lg:gap-x-3" href="#" aria-label="Brand">
                <img class="max-h-20" src="{{ asset('assets/img/logo_pmr.png') }}" />
                <div
                ...
                <div class="py-2 md:py-0  flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
                    <div class="grow">
                        <div class="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
                            <a class="p-2 flex items-center text-sm bg-gray-100 text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-hidden focus:bg-gray-100 hover:text-yellow-600 "
                            ...
                            <div
                                ...
                                <button id="hs-header-base-mega-menu-fullwidth" type="button"
                                    class="hs-dropdown-toggle w-full p-2 flex items-center text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-hidden focus:bg-gray-100 hover:text-yellow-600"
                                    ...
                                    <div class="md:mx-6 lg:mx-8 md:bg-white md:rounded-lg md:shadow-md">
                                        <div class="py-1 md:p-2 md:grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-3">
                                            <div class="flex flex-col">
                                                <a class="p-3 flex gap-x-4 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 rounded-lg hover:text-yellow-600"
                                                    href="#">
                                                    ...
                                                    <div class="grow">
                                                        <p
                                                            class="font-medium text-sm text-gray-800 hover:text-yellow-600 ">
                                                            Sejarah</p>
                                                    </div>
                                                </a>
                            ...
                            <a class="p-2 flex items-center text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-hidden focus:bg-gray-100 hover:text-yellow-600"
                                href="#">
                                <svg class="shrink-0 size-4 me-3 md:me-2 block md:hidden"
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <div class=" flex flex-wrap items-center gap-x-1.5">
                        <a class="py-2 px-2.5 inline-flex items-center font-medium text-sm rounded-lg bg-yellow-600 text-white hover:bg-yellow-700"
                            href="#">
                            Login
                        </a>
                    </div>
