...
@section('content')
    ...
    <section class="relative min-h-screen bg-cover bg-center bg-no-repeat"
        ...
        <div class="relative z-20 flex flex-col justify-center items-center text-white min-h-screen text-center px-6">
            <h1 class="text-4xl md:text-6xl font-bold mb-4"><span class="text-red-600">PMR</span> <span class="text-yellow-500">Wira</span> <br>
            ...
            <a href="{{ route('profil.index') }}#sejarah" class=" text-white py-2 px-4 rounded transition duration-300 btn-yellow-to-red"><span
                    class="text font-bold">Lihat Sejarah</span></a>
        </div>
    </section>
